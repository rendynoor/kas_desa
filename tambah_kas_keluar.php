                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="" method="post" enctype="multipart/form-data">                                
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Masukkan Jumlah Harga<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
							...
							$jenis = "keluar";
							$query = $koneksi->query("INSERT INTO kas (keterangan,tanggal,kas_masuk,jenis,kas_keluar) VALUES ('$keterangan','$tanggal','0','keluar','$kas_keluar')");
